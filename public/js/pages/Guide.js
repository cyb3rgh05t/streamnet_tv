...
class GuidePage {
  ...
  async show() {
    // Always default to Favorites when entering Guide; fallback to All Groups is handled in EpgGuide.render.
    this.app.epgGuide.selectedGroup = "Favorites";
    ...
    if (
      !this.app.epgGuide.programmes ||
      this.app.epgGuide.programmes.length === 0
    ) {
